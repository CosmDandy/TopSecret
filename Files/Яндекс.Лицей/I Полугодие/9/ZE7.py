...
while answer != "Пока":
    ...
    if "муз" in answer or "компьют" in answer \
        ...
        if "муз" in answer:
            ...
            if "Да" in answer or "да" in answer:
                ...
                if "Да" in answer or "да" in answer:
                    ...
                    if "Да" in answer or "да" in answer:
                        ...
                        print("Давайте поговорим о чем-то ещё ?")
                        answer = "?"
                    elif "Нет" in answer or "не" in answer:
            ...
            while answer != "Пока" or answer != "?":
                ...
                if "?" in answer:
                    ...
                    print("Понятно")
                    print("У меня есть еще много тем для разговоров. К примеру эти...")
                    answer = "?"
                    break
        ...
        print()
        print("Напиши '?' чтобы вызвать темы для разговоров")
